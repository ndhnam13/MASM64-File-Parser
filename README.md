...
- Tại đây ta sẽ lấy 4 byte đầu là RVA của firstFunctionOffset, áp dụng công thúc để tìm ra offset

```
firstFunctionOffset = [imageBase + <section>.RawOffset + (firstFunctionRVA − <section>.VA)] + 2
```
